...
- `openai-codex/gpt-5.4`（2026-03-05）、`openai-codex/gpt-5.2`
- `anthropic/claude-sonnet-4-6`（2026-02-17）、`anthropic/claude-opus-4-6`（2026-02-05）、`anthropic/claude-opus-4-7`（2026-04-16）
...
常用模型标识：`anthropic-vertex/claude-sonnet-4-6`、`anthropic-vertex/claude-opus-4-6`、`anthropic-vertex/claude-opus-4-7`
