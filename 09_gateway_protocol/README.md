...
- **[9.3 WebSocket 握手、认证与连接生命周期](9.3_ws_handshake.md)**：理解 WebSocket 长连接的握手、认证与生命周期治理要点。
- **[9.4 事件幂等与一致性保障](9.4_event_idempotency.md)**：掌握事件驱动系统的幂等与一致性：为什么“至少一次”是常态。
- **[9.5 渠道配对与本地信任建立](9.5_pairing_trust.md)**：理解 DM 配对作为信任引导（bootstrapping）的意义，以及吊销与轮换的治理方法。区分渠道配对与设备配对。
