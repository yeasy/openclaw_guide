...
> **⚠️ 以下为假设性教学场景，非真实安全事件**
>
> 从 ClawHub 下载技能包时，必须正视其背后的供应链风险。2026 年 2 月，Snyk 的安全研究报告（*Leaky Skills*）披露：ClawHub 共收录约 3,984 个技能，其中 **283 个（7.1%）存在凭据泄露风险**。同月，Koi Security 的 *ClawHavoc* 调查进一步发现了 **341 个恶意技能**，以及一个严重的远程代码执行漏洞 CVE-2026-25253。由于技能本质上是 markdown 文件，容易通过精心设计的 prompt 被用作”诱导式的恶意指令执行工具”。
