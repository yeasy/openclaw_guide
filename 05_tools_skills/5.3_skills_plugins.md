...
你可以在 Dashboard 的 Skills 页面查看当前所有内置能力的列表以及启停情况，如下图所示：

![Skills 技能库管理](images/skills_interface.png)

图 5-2：Skills 技能库管理

同样，你也可以通过 CLI 语义搜索并安装别人建好的能力包：
...
> **[假设性安全场景]** 以下为教学用途的假设性场景描述，用以说明技能生态中可能面临的安全风险类型。

在享受从 ClawHub 一键下载”黑客指令集”的快感时，必须正视其背后的供应链隐患。2026 年 2 月，Snyk 的安全研究报告（*Leaky Skills*）披露：ClawHub 共收录约 3,984 个技能，其中 **283 个（7.1%）存在凭据泄露风险**。同月，Koi Security 的 *ClawHavoc* 调查进一步发现了 **341 个恶意技能**，以及一个严重的远程代码执行漏洞 CVE-2026-25253。由于技能只是 markdown 文件，它常常通过复杂的 prompt 被用作一种”诱导式的恶意载荷执行器”。
