...
官方建议的桌面端入口是 Dashboard，参考：https://docs.openclaw.ai/zh-CN/web/desktop。
...
默认情况下，Dashboard 运行在 `http://localhost:18789`（以官方说明为准）。参考：https://docs.openclaw.ai/zh-CN/web/desktop。
...
- Web 桌面端：https://docs.openclaw.ai/zh-CN/web/desktop
