...
官方提供多智能体沙箱与认证档案机制，用于把高风险能力与低风险能力隔离到不同智能体与不同工作区，并让 key 选择可追溯。参考：https://docs.openclaw.ai/zh-CN/tools/multi-agent-sandbox-tools。

落地时建议把“入口智能体”和“执行智能体”分离：入口负责路由与收敛，执行负责受限动作。

### 11.4.3 审计与脱敏：诊断配置是防护栏的一部分

生产环境应默认开启诊断脱敏与可控落盘，避免把密钥与敏感数据写进日志。相关配置见：https://docs.openclaw.ai/zh-CN/gateway/configuration#diagnostics。
