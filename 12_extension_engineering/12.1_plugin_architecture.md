...
插件的启用通常通过 `plugins.entries` 声明。每个条目包含唯一标识、启用开关与插件自定义配置。官方文档给出了 `enabled`、`config` 等字段的写法，并说明了如何在不卸载插件的情况下快速启停：[https://docs.openclaw.ai/tools/plugin](https://docs.openclaw.ai/tools/plugin)。
