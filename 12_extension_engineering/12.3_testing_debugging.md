...
- 自检：[https://docs.openclaw.ai/zh-CN/cli/doctor](https://docs.openclaw.ai/zh-CN/cli/doctor)
- 状态：[https://docs.openclaw.ai/zh-CN/cli/status](https://docs.openclaw.ai/zh-CN/cli/status)
- 插件：[https://docs.openclaw.ai/zh-CN/cli/plugins](https://docs.openclaw.ai/zh-CN/cli/plugins)
- 渠道：[https://docs.openclaw.ai/zh-CN/cli/channels](https://docs.openclaw.ai/zh-CN/cli/channels)
- 模型：[https://docs.openclaw.ai/zh-CN/cli/models](https://docs.openclaw.ai/zh-CN/cli/models)
...
官方插件文档说明了如何通过 `enabled` 快速启停插件，并通过白名单控制可用范围：[https://docs.openclaw.ai/zh-CN/tools/plugin](https://docs.openclaw.ai/zh-CN/tools/plugin)。
