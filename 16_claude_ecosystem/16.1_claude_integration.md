...
Anthropic 的 Claude 模型长期按能力与成本分为三个系列（2026-06-09 起，新一代 Fable 5 / Mythos 5 位于这三档之上；2026-06-12 起 Anthropic 暂停两者访问）：
...
| **Fable 5** | 新一代旗舰：能力最强的广泛发布模型（2026-06-09 GA，$10/$50）；2026-06-12 起访问暂停 | Anthropic 官方发布规格为 1M、128K 输出；OpenClaw 可用性以当前 provider/model catalog 为准 | Adaptive Thinking 常开（不可关闭）；同日发布的 Mythos 5 仅限受邀且同样暂停访问 |
