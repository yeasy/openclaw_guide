...
| **Opus 4.8** | Anthropic 当前最强通用推理与长程编码模型 | Anthropic 官方默认 1M；OpenClaw 可用性以当前 provider/model catalog 为准 | 默认 `effort=high`，thinking 细节以当前 provider/model catalog 为准 |
