...
截至 2026-05-16，OpenAI 官方 agent 栈通常涉及 Responses API、Agents SDK、内置工具/函数调用、tracing 与 guardrails 等组件。本节只讲 OpenClaw 的 OpenAI provider 接入和混合模型路由，不等同于完整介绍 OpenAI 原生 agent 平台；需要直接构建 OpenAI 原生 agent 时，应回到 OpenAI Agents SDK 与 Responses API 文档确认当前接口。
