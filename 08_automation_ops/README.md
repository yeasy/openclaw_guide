...
- **[8.3 远程访问：SSH、内网穿透与零信任](8.3_remote_access.md)**：在”可达”与”不暴露”之间找到平衡，建立安全的远程访问通道。
- **[8.4 安全基线与审计流程](8.4_security_baseline.md)**：建立结构化审计机制，让系统的每一次关键写入都可溯源、可复盘。
- **[8.5 本章小结](summary.md)**：关键结论与读者自检。
