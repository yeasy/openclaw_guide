...
如果你拿不准该选 Cron 还是 Heartbeat，这里只做**首轮分流**：先判断“是不是精确时间点任务”。更细的会话、上下文和模型差异，统一放到 [8.3.8 Heartbeat vs Cron](8.3_heartbeat.md#838-heartbeat-vs-cron) 再展开，避免同一问题在两节里重复讲两遍。
