...
├──────────────────┼──────────────┼──────────────┼─────────────┤
│ Rate Limiting    │ 429响应      │ API限速      │ < 5分钟     │
│ Token Exhaustion │ 401/超额费用  │ Token预算不足 │ 10-15分钟   │
│ Queue Overflow   │ 超时/丢弃    │ 消费速度慢    │ 15-30分钟   │
│ Memory Leak      │ OOM错误      │ 内存未释放    │ 30-60分钟   │
│ Connection Pool  │ 连接超时      │ 连接泄漏      │ 20-40分钟   │
│ Cascading Failure│ 全系统故障    │ 无故障转移    │ 5-10分钟    │
│ Thundering Herd  │ 突发高峰      │ 并发spike    │ 5-15分钟    │
│ Tail Latency     │ P99响应时间高 │ 不均匀分布    │ 30-45分钟   │
└──────────────────┴──────────────┴──────────────┴─────────────┘
```
